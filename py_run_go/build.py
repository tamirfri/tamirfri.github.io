# python build stubs for package lodash
...
add_checked_string_function(mod, 'lodash_Find', retval('char*'), [param('char*', 'objectListJSON'), param('char*', 'subObjectJSON')])

mod.generate(open('lodash.c', 'w'))
