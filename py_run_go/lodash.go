...
#cgo CFLAGS: -I/home/linuxbrew/.linuxbrew/opt/python@3.11/include/python3.11 -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: -L/home/linuxbrew/.linuxbrew/opt/python@3.11/lib -lpython3.11 -ldl -lm
...
import (
	...
	"github.com/tamirfri/gopy/gopyh" // handler
...
// --- generated code for package: lodash below: ---
...
//export lodash_Find
func lodash_Find(objectListJSON *C.char, subObjectJSON *C.char) *C.char {
	_saved_thread := C.PyEval_SaveThread()
	cret, __err := lodash.Find(C.GoString(objectListJSON), C.GoString(subObjectJSON))
