...
#cgo CFLAGS: -I/home/linuxbrew/.linuxbrew/opt/python@3.10/include/python3.10 -Wno-error -Wno-implicit-function-declaration -Wno-int-conversion
#cgo LDFLAGS: -L/home/linuxbrew/.linuxbrew/opt/python@3.10/lib -lpython3.10 -lcrypt -ldl  -lm -lm
...
//export lodash_Find
func lodash_Find(objects *C.char, partialObject *C.char) *C.char {
	_saved_thread := C.PyEval_SaveThread()
	cret, __err := lodash.Find(C.GoString(objects), C.GoString(partialObject))
